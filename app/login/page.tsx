  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="bg-red-950/30 rounded-xl p-8 border border-red-800/50">
          {error && (
        ...
        <p className="text-center text-gray-400 mt-6">
          ...
          <Link href="/signup" className="text-red-400 hover:text-red-300">Sign up</Link>
        </p>
      </div>
    </main>
  )
